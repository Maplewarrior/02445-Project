...
optimal_trees_xy = [300, 450, 150, 300, 375, 525, 375, 75 , 300, 450,
...
optimal_hidden_units_xy = [4, 5, 2, 7, 4, 4, 6, 9 ,5 , 7,
                           9, 5, 8, 3, 3, 5, 3, 7, 11, 10,
                           4, 11, 10, 6, 7, 7, 4, 7, 4, 5]
E_gen_ANN_final_xy = np.array([
...
optimal_lambdas_xy = [1e-08, 1.0, 0.01, 1.0, 0.1, 1e-05, 10.0, 1e-08 , 0.01, 1.0,
                      1.0, 1e-05, 1e-06, 1.0, 10.0, 1e-05, 0.1, 1e-07, 1.0, 1.0, 
                      0.01, 1.0, 1e-8, 1e-8, 0.1, 10, 0.0001, 0.01, 1e-06, 1e-07 ]
E_gen_LogReg_final_xy = np.array([
...
######## For (x,z)
optimal_trees_xz = [525, 675, 450, 525, 300, 525, 150, 300, 375, 750,
...
optimal_hidden_units_xz = [4, 1, 1, 4, 2, 2, 4, 3, 1, 7,
                           1, 2, 1, 2, 8, 1, 1, 2, 3, 1,
                           8, 2, 3, 2, 1, 2, 2, 2, 4, 4
                           ]
E_gen_ANN_final_xz = np.array([[0.71875, 0.7, 0.7625, 0.7375, 0.75, 0.71875, 0.75, 0.7377, 0.675, 0.69375, 
...
optimal_lambdas_xz = [10, 1, 1e-6, 10, 1e-7, 1e-6, 10, 1e-6, 1e-8, 1,
                      1e-7, 10, 1e-5, 1e-8, 1e-8, 1, 1e-8, 1, 10, 1, 
                      0.01, 10.0, 10.0, 1e-08, 1e-08, 1e-08, 1e-08, 1.0, 1.0, 1e-08]

E_gen_LogReg_final_xz = np.array([0.69375, 0.7125, 0.74375, 0.68125, 0.65625, 0.7375, 0.70625, 0.7125, 0.66875, 0.71875,
